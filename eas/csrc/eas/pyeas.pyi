...
class AbruptDhState:
    ...
    def __str__(self) -> str:
        ...
    def action_mask(self) -> typing.Annotated[list[bool]]:
        ...
...
################# 4x4 states and solvers ########################################
class AbruptDh4CfrSolver:
    def __init__(self, traverser: AbruptDh4Traverser, cfr_conf: CfrConf) -> None:
        ...
    def avg_bh(self) -> tuple[numpy.ndarray[numpy.float64], numpy.ndarray[numpy.float64]]:
        ...
    def step(self) -> None:
        ...
class AbruptDh4State:
    # OPENSPIEL_INFOSTATE_SIZE: typing.ClassVar[int] = 108
    def __init__(self) -> None:
        ...
    def __repr__(self) -> str:
...
class AbruptDh4Traverser:
    ...
    def NUM_INFOS_PL1(self) -> int:
        ...
class Dh4CfrSolver:
    def __init__(self, traverser: Dh4Traverser, cfr_conf: CfrConf) -> None:
        ...
    def avg_bh(self) -> tuple[numpy.ndarray[numpy.float64], numpy.ndarray[numpy.float64]]:
        ...
    def step(self) -> None:
...
#new
@typing.overload
def CfrSolver(traverser: AbruptDh4Traverser, cfr_conf: CfrConf) -> AbruptDh4CfrSolver:
    ...
@typing.overload
def CfrSolver(traverser: Dh4Traverser, cfr_conf: CfrConf) -> Dh4CfrSolver:
    ...